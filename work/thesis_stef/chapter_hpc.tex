...
measure the execution time. Therefore an application can be compared
with an improved version through their execution times.
The performance gain can be then expressed as shown in
...
and consequently the speedup would equal be to the number of
processors $p$.
...
has became known as \textit{Amdahl's Law for parallel computing}.
...
\item[R] is a free software environment for statistical computing and
  ...
  chapter (Chapter~\ref{chap:Rhpc}) about R and high performance computing.
