...
Then the defined benchmark is carried out. For each complexity and
...
\code{n\_ncpu} number of R slaves are spawned. The master
...
example by package \pkg{snow}, perform not so good. This is because
